...
def GetDeviceOnlineList():
    ...
    while page <= pageCount:
        ...
        for device in jsonDump['data']:
            ##IF: test to make sure device is an APs and test to verify device has a network policy assigned. Network Policy test filters out attached controllers and its APs.
            if device['device_function'] == 'AP' and device['network_policy_name'] != '':
